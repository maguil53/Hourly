...
class Converters {
    ...
    @TypeConverter fun blockStateToInt(blockState: BlockState): Int = blockState.ordinal

    @TypeConverter fun intToBlockState(stateInt: Int): BlockState = enumValues<BlockState>()[stateInt]
